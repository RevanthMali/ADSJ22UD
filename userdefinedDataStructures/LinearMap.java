...
public class LinearMap <K,V>{
		...
		Set<Entry> entrySet(){ // returns set of data in the set
		...
		Set<K> keyset(){ // set don't consists of duplicate elements
...
//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